...
class PlaceRepository extends RepositoryAbstract
{
    public $model;
    ...
    public function __construct(Place $model, TranslationRepository $translationRepo)
    {
        $this->model = $model;
        $this->translationRepo = $translationRepo;
        $this->table = config('cms.db-prefix').'places';
    }

    /**
     * Returns all published Places.
     *
     * @return \Illuminate\Database\Eloquent\Collection|static[]
     */
    public function findPlacesByDate($date)
    {
