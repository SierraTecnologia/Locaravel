    ...
    function () {
        ...
        $(".hamburger, .navbar-expand-toggle").on(
            'click', function () {
                ...
                if ($(this).hasClass('is-active')) {
                    window.localStorage.setItem('justice.stickySidebar', true);
                } else {
                    window.localStorage.setItem('justice.stickySidebar', false);
                }
            }
        );
        ...
        $(document).on(
            'click', '.panel-heading a.panel-action[data-toggle="panel-collapse"]', function (e) {
                ...
                if (!$this.hasClass('panel-collapsed')) {
                    ...
                    $this.removeClass('justice-angle-up').addClass('facilitador-angle-down');
                } else {
                    $this.parents('.panel').find('.panel-body').slideDown();
                    $this.removeClass('panel-collapsed');
                    $this.removeClass('justice-angle-down').addClass('facilitador-angle-up');
                }
            }
        );
        ...
        $(document).on(
            'click', '.panel-heading a.panel-action[data-toggle="panel-fullscreen"]', function (e) {
                e.preventDefault();
                var $this = $(this);
                if (!$this.hasClass('justice-resize-full')) {
                    $this.removeClass('justice-resize-small').addClass('facilitador-resize-full');
                } else {
                    $this.removeClass('justice-resize-full').addClass('facilitador-resize-small');
                }
