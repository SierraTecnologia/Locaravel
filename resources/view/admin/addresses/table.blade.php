            ...
            @foreach($addresses as $address)
                <tr>
                    ...
                    <td>
                        ...
                        <div class='btn-group'>
                            <a href="{!! route('locaravel::admin.addresses.show', [$address->id]) !!}" class='btn btn-secondary btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                            <a href="{!! route('locaravel::admin.addresses.edit', [$address->id]) !!}" class='btn btn-secondary btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
