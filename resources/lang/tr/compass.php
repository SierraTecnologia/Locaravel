...
return [
    'welcome'                => 'Justice Pusula\'ya hoşgeldiniz. Her iyi uygulama doğru istikamette ilerlemek için bir pusulaya ihtiyaç duyar.
    Bu bölümde uygulamanızı geliştirirken size rehberlik edecek bir çok kaynak ve yönetimsel görev bulacaksınız.',
    'links'         => [
        'title'                 => 'Bağlantılar',
        'documentation'         => 'Dokümantasyon',
        'justice_homepage'      => 'Justice Anasayfa',
        'justice_hooks'         => 'Justice Hookları',
    ],
    'commands'      => [
        'title'                 => 'Komutlar',
        'text'                  => 'Artisan Komutlarını Justice\'dan Çalıştır.',
    ...
    'resources'     => [
        'title'                 => 'Kaynaklar',
        'text'                  => 'Aradığınız şeyleri bulmanızı kolaylaştıracak Justice kaynakları.',
    ...
    'fonts'         => [
        'title'                 => 'İkonlar',
        'font_class'            => 'Justice İkon Class Eşleştirmesi',
        'font_character'        => 'Justice İkon Karakter Eşleştirmesi',
    ],
];
