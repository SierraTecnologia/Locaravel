...
return [
    'welcome'                => '
    به قطب نمای justice خوش آمدید! هر اپلیکیشن خوب باید یک قطب نما داشته باشد که کاربران را به جهات صحیح هدایت کند!.
    ...
    'links'         => [
        ...
        'justice_homepage'      => 'صفحه اصلی facilitador',
        'justice_hooks'         => 'هوک های facilitador',
    ],
    'commands'      => [
        'title'                 => 'دستورات',
        'text'                  => 'اجرای دستورات Artisan از justice',
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع Justice برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت Justice',
        'font_character'        => 'نقشه کاراکترهای فونت Justice',
    ],
];
