...
return [
    'welcome'                => 'Bienvenue sur Justice Compass. Chaque nouvelle application a besoin d\'une boussole pour se diriger dans la bonne direction.
    ...
    'links'         => [
        ...
        'justice_homepage'      => 'Justice Homepage',
        'justice_hooks'         => 'Justice Hooks',
    ],
    'commands'      => [
        'title'                 => 'Commandes',
        'text'                  => 'Lancer les Commandes artisan depuis Justice.',
    ...
    'resources'     => [
        'title'                 => 'Ressources',
        'text'                  => 'Ressources Justice pour vous aider a trouver certaines choses plus vite.',
    ],
    'logs'          => [
        'title'                 => 'Logs',
    ...
    'fonts'         => [
        ...
        'font_class'            => 'Classe de correspondance à la police Justice',
        'font_character'        => 'Caractère de correspondance à la police Justice',
    ],
];
