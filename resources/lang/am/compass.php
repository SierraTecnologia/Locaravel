...
return [
    'welcome'                => 'Բարի գալուստ Justice կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'justice_homepage'      => 'Justice Գլխավոր էջ',
        'justice_hooks'         => 'Justice Hooks',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները Justice-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'Justice-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'Justice-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'Justice-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];
