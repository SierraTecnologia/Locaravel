...
return [
    'welcome'                => 'Bienvenido(a) a Justice Compass. Toda buena aplicación necesita una brújula que guíe en la dirección correcta.
    En esta sección encontrará recursos y tareas administrativas para ayudarle con la construcción de su aplicación.',
    'links'         => [
        'title'                 => 'Enlaces',
        'documentation'         => 'Documentación',
        'justice_homepage'      => 'Página de inicio de Justice',
        'justice_hooks'         => 'Justice Hooks',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Ejecute comandos Artisan desde Justice.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Recursos sobre Justice a la mano.',
    ],
    'logs'          => [
        'title'                 => 'Registros',
    ...
    'fonts'         => [
        'title'                 => 'Fuentes',
        'font_class'            => 'Mapa de clases de Justice Fonts',
        'font_character'        => 'Mapa de caracteres de Justice Fonts',
    ],
];
