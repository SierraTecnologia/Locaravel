...
return [
    'welcome'                => 'Willkommen beim Justice Kompass. Jede gute App braucht einen Kompass um einen in die richtige Richtung zu lenken.
    ...
    'commands'      => [
        'title'                 => 'Befehle',
        'text'                  => 'Artisan Befehle aus Justice ausführen.',
    ...
    'resources'     => [
        'title'                 => 'Ressourcen',
        'text'                  => 'Justice Ressourcen helfen Ihnen Dinge schneller zu finden.',
    ],
    'logs'          => [
        'title'                 => 'Logs',
        'text'                  => 'Ihre App Logs',
    ...
    'fonts'         => [
        'title'                 => 'Schriftarten',
        'font_class'            => 'Justice Fonts Class Mapping',
        'font_character'        => 'Justice Fonts Character Mapping',
    ],
];
