...
return [
    'welcome'                => 'Добро пожаловать в Justice Compass. Каждое хорошее приложение нуждается в компасе, чтобы указать им в правильном направлении.
     В этом разделе вы найдете много ресурсов и административных задач, которые помогут вам в создании вашего приложения.',
    'links'         => [
        'title'                 => 'Ссылки',
        'documentation'         => 'Документация',
        'justice_homepage'      => 'Страница Justice',
        'justice_hooks'         => 'Хуки Justice',
    ],
    'commands'      => [
        'title'                 => 'Команды',
        'text'                  => 'Запустите команду Artisan от Justice.',
    ...
    'resources'     => [
        'title'                 => 'Ресурсы',
        'text'                  => 'Ресурсы Justice, которые помогут вам найти вещи быстрее.',
    ...
    'fonts'         => [
        'title'                 => 'Шрифты',
        'font_class'            => 'Карта классов шрифта Justice',
        'font_character'        => 'Карта символов шрифта Justice',
    ],
];
